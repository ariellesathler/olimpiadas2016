...
<div class="texto-modalidade">
  ...
  <p>
      ...
      <br>Uma partida de futebol é vencida pela equipe que marcar um maior número de gols, em dois períodos de quarenta e cinco minutos, tendo um intervalo de quinze minutos de um para o outro, dando um total de jogo de noventa minutos.
  </p>
  ...
  <p>
      Uma equipe é composta por 18 jogadores, sendo 7 deles reservas. Em uma partida é obrigatório que um time tenha um goleiro, as demais posições são:
        ...
        • Meia-armador
        • Médio Centro
        • Meio-campista Lateral direito e esquerdo
        • Meia-atacante
        • Ponta
        • Segundo Atacante
        • Centroavante
  ...
  <h2>Regras</h2>
  <p>
      As regras do futebol foram criadas pela International Football Association Board (IFAB)  são:O <br>• Campo de jogo: O campo deve ser retangular.
        ...
        • Árbitro de Futebol: Cada partida deve ter um árbitro, que deve ser a autoridade em campo e recebe auxílio de dois juízes de linhas, conhecidos como bandeirinhas. Ele realiza a vistoria do gramado, aplica as regras e soluciona lances duvidosos. Ele pode alterar sua decisão caso perceba que está incorreta.
        ...
        • Falta no Jogo e conduta antidesportivas: é concedido pelo árbitro um tiro livre direto para o jogador que comete faltas de uma forma que imprudente ou violenta. Agarrar um adversário, chutá-lo, empurrá-lo, tocar a bola com as mãos, dentre outras. Caso ocorra uma falta desportiva recorrente ou incitação à violência ao adversário, o jogador pode ser advertido com um cartão amarelo. As faltas passíveis de cartão vermelho são a conduta violenta do jogador, impedir um gol com a mão se você não for o goleiro, empregar linguagem ofensiva e receber o segundo cartão de advertência na partida.
  ...
  <p>
    Sua estréia em Jogos Olímpicos foi em 1900 na cidade de Paris na França, sendo o segundo esporte coletivo a entrar oficialmente nos Jogos Olímpicos
  </p>
